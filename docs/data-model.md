...
- `course_breaks.course_id` dokumentiert einen vom Büro erfassten Ferien- oder Ausfallzeitraum und sagt die darin liegenden, künftig geplanten Lektionen ab. Bei einer späteren Wochenplanänderung bleiben diese Datumsbereiche ebenfalls als abgesagte Lektionen erhalten.
...
| --- | --- | --- |
| Kurs | `/api/courses/:courseId` | Lehrperson, Standardraum/Standort, Wochenplan, Unterbrüche, Lektionen, Teilnahmen, Anwesenheiten, Qualifikationen, Historie |
...
Die Migrationen `013_person_identity_and_notes.sql` bis `019_course_breaks.sql` werden beim Start des Containers automatisch angewendet.
