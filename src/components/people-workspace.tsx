...
type Person = { id: string; name: string; email: string; role: PersonRole; phone?: string | null; street?: string | null; postal_code?: string | null; city?: string | null; notes?: string | null; teacher_code?: string | null; rate_per_lesson?: number | null; teaching_levels?: TeachingLevel[]; course_count?: number; history?: Array<{ eventType: string; summary: string; occurredAt: string }> };
